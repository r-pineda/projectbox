      ...
      .then((data) => {
        ...
        if(this.todo.comments){
          this.todo.comments.forEach((comment) => {
            ...
            comment.date = date.getDate() + "." + date.getMonth() + "." + date.getFullYear() + " um " + (date.getHours()>9?date.getHours():"0"+date.getHours()) + ":" + (date.getMinutes()>9?date.getMinutes():"0"+date.getMinutes());
          });
        }
